...
function createCards(produto) {
    ...
    card.innerHTML = '<a target="_blank" href="' + produto.link + '" class="card-link">' +
        '<div class="pCard-img"><img src="assets/images/Produtos/' + produto.imagem + '"></div>' +
        '<div class="pCard-body">' +
        "<span class=\'badge bg-dark mug-tag\'>" + produto.tag + "</span>" +
        "<p class=\"mug-name\">" + produto.nome + "</p>" +
